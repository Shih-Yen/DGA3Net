...
from pytorch_grad_cam_3d.utils.find_layers import replace_layer_recursive
from pytorch_grad_cam_3d.ablation_layer import AblationLayer
    ...
    def get_cam_weights(self,
        ...
        with torch.no_grad():
            ...
            for batch_index, (target, tensor) in enumerate(zip(targets, input_tensor)):
                new_scores = []
                batch_tensor = tensor.repeat(*([self.batch_size, 1]+img_ndims*[1]))
